...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Manajemen Kebijakan Privasi</h1>
        
        <form action="" id="form_cari" method="post">
            @csrf
            <div class="input-group">
                <input type="text" class="form-control" placeholder="Cari kebijakan privasi" name="cari" id="cari">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Data Kebijakan Privasi</h6>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered" id="TkebijakanPrivasi" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <th>Judul</th>
                            <th>Konten</th>
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Data Kebijakan Privasi</h5>
                ...
                <div class="modal-body" style="max-height: 70vh; overflow-y: auto;">
                    <div class="form-group">
                        ...
                        <input type="text" id="judul" name="judul" class="form-control" placeholder="Judul kebijakan privasi" required>
                    </div>
                    <div class="form-group">
                        <label for="">Konten <span class="text-danger">*</span></label>
                        <textarea id="content" name="content" class="form-control" rows="8" placeholder="Konten kebijakan privasi" required></textarea>
                    </div>
                    <div class="form-group">
...
<form id="updateForm" method="post">
    ...
    <div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Update Data Kebijakan Privasi</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body" style="max-height: 70vh; overflow-y: auto;">
                    ...
                    <div class="form-group">
                        <label for="">Judul <span class="text-danger">*</span></label>
                        <input type="text" id="judul_update" name="judul" class="form-control" placeholder="Judul kebijakan privasi" required>
                    </div>
                    <div class="form-group">
                        <label for="">Konten <span class="text-danger">*</span></label>
                        <textarea id="content_update" name="content" class="form-control" rows="8" placeholder="Konten kebijakan privasi" required></textarea>
                    </div>
                    <div class="form-group">
                        <label for="">Status <span class="text-danger">*</span></label>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Apakah Anda yakin ingin menghapus data kebijakan privasi ini?</p>
...
<script>
    ...
    $(document).ready(function(e){
        ...
        var TkebijakanPrivasi = $('#TkebijakanPrivasi').DataTable({
            "responsive": true,
            'searching': false,
            "processing": true,
            "serverSide": true,
            ...
            "paging":true,
            "ajax":{
                "url":"{{ route('editor.kebijakan-privasi.data') }}",
                "data":function(parm){
        ...
        $("#proses_add").click(function(){
            ...
            $.ajax({
                url:"{{ route('editor.kebijakan-privasi.store') }}",
                data: formData,
                type:"POST",
                dataType:"JSON",
                processData: false,
        ...
        $(document).on('click', '.btnUpdate', function(){
            ...
            var table = $('#TkebijakanPrivasi').DataTable();
            var data = table.row(row).data();
            var id = data.id;
            
            $.ajax({
                url: "{{ route('editor.kebijakan-privasi.detail') }}",
                type: "GET",
                data: {id: id},
                dataType: "JSON",
                beforeSend: function(){
        ...
        $("#proses_update").click(function(){
            ...
            $.ajax({
                url:"{{ route('editor.kebijakan-privasi.update') }}",
                data: formData,
                type:"POST",
                dataType:"JSON",
                processData: false,
        ...
        $("#confirm_delete").click(function(){
            if(deleteId !== null){
                $.ajax({
                    url: "{{ route('editor.kebijakan-privasi.delete') }}",
                    type: "DELETE",
                    data: {
                        id: deleteId,
                        _token: "{{ csrf_token() }}"
